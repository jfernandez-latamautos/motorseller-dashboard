    ...
    open && mounted
      ? createPortal(
          <div className="fixed inset-0 z-[100] md:hidden">
            ...
            />
            <div className="absolute inset-x-0 bottom-0 flex max-h-[88vh] flex-col rounded-t-3xl bg-[var(--surface)] pb-[env(safe-area-inset-bottom)] shadow-[var(--shadow-md)]">
                ...
                <div className="flex flex-col gap-4 p-4">
                  <label className="block">
                    ...
                    <input
                      ...
                      placeholder="Nombre o ID de agencia"
                      className={field}
                    />
                  </label>
                  ...
                  <label className="block">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFilters({
                          accessType:
                            e.target.value as typeof filters.accessType,
                        })
                      }
                      className={field}
                    >
              ...
              <div className="flex shrink-0 gap-2 border-t border-[var(--border)] bg-[var(--surface)] p-4">
                <button
                  type="button"
  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-10 shrink-0 items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--surface)] px-3.5 text-sm font-semibold text-[var(--ink)]"
      >
